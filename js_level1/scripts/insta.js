...
// 콜뱀함수 호출이 아닌 익명함수 또는 화살표함수 이용필수
...
// 6. 댓글 아이콘 터치 시 댓글 입력창 실행(o) - 제작필요, 실행화면에서 바깥쪽 영역 터치 댓글입력창 닫힘 (o) 
...
//storyDOM.addEventListener('click',()=>{tagDOM.style.display='block'});
// 10. 해시태그 터치 시 해당 태그 사용 게시글 페이지 이동 (o)
console.log(tagDOM);
tagDOM.addEventListener('click',tagGo);
function tagGo(){
    return window.location = 'insta_tag.html';
}
