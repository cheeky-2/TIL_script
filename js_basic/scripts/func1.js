...
// const msg1 = window.alert('이 웹페이지는 포트폴리오입니다.') //alert은 사이트에 들어갈때 뜨는 팝업창 안내문 같은 느낌
// const msg2 = window.prompt('1+1은?');
// prompt에서 사용자가 입력한 값이 최종 변수에 대입된다.
// prompt에 값을 적지 않으면 null(빈값)이 출력된다.
// console.log(msg2);
// console.log(typeof msg2); // prompt값은 숫자를 적어도 문자열로 인식한다.
// ==========================사용자 정의 함수
...
// 생성만으론 실행결과를 볼 수 없고 반드시 호출을 별도로 해야한다.
// func1(); // 호출은 함수밖에서!
