...
const nextBtn = document.querySelector('.toon_wrap_all .next');
const prevBtn = document.querySelector('.toon_wrap_all .prev');
console.log(toonWrap,nextBtn,prevBtn);
nextBtn.addEventListener('click',()=>{
    //toonWrap.scrollBy(200,0);
...
prevBtn.addEventListener('click',()=>{
    toonWrap.scrollBy({left:-toonWrap.children[0].children[0].offsetWidth, top:0, behavior:'smooth',})
})
