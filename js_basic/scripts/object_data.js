...
console.log(`제가 좋아하는 색상은 ${colorArray[1]},${colorArray[3]},${colorArray[4]}입니다.`)
// 과일 역순으로 출력하기
...
console.log('영화 제목 :',movieAll[1].name);
console.log('볼 수 있는 나이 :',movieAll[1].age);
console.log('장르 :',movieAll[1].genre);
console.log('줄거리 간단 소개 :',movieAll[1].story);
console.log('=================================위의 영화 같이 보러 갈 사람 구함');
