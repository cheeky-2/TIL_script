...
resultBtn.addEventListener('click',function(){
    /* if(userMonth.value >= 1 && userMonth.value <= 12){
        outputMsg.textContent = `${birthday_flower[userMonth.value-1].month}월의 탄색화는 ${birthday_flower[userMonth.value-1].flower}, 꽃말은 ${birthday_flower[userMonth.value-1].content}`입니다.} */
